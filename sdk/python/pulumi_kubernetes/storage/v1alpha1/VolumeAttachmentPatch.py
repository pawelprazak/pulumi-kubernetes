...
class VolumeAttachmentPatchArgs:
    ...
    @property
    @pulumi.getter
    def spec(self) -> Optional[pulumi.Input['VolumeAttachmentSpecArgs']]:
        """
    ...
    @spec.setter
    def spec(self, value: Optional[pulumi.Input['VolumeAttachmentSpecArgs']]):
...
class VolumeAttachmentPatch(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="kubernetes:storage.k8s.io/v1:VolumeAttachment"), pulumi.Alias(type_="kubernetes:storage.k8s.io/v1beta1:VolumeAttachment")])
