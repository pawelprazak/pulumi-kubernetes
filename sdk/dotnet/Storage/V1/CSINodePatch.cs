    ...
    public partial class CSINodePatch : KubernetesResource
    {
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new Pulumi.Alias { Type = "kubernetes:storage.k8s.io/v1beta1:CSINode"},
                },
            };
...
namespace Pulumi.Kubernetes.Types.Inputs.Storage.V1
{
    ...
    public class CSINodePatchArgs : Pulumi.ResourceArgs
    {
        /// <summary>
        /// APIVersion defines the versioned schema of this representation of an object. Servers should convert recognized schemas to the latest internal value, and may reject unrecognized values. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#resources
        /// </summary>
        ...
        /// </summary>
        [Input("spec")]
        public Input<Pulumi.Kubernetes.Types.Inputs.Storage.V1.CSINodeSpecArgs>? Spec { get; set; }
