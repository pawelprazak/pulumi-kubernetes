...
namespace Pulumi.Kubernetes.FlowControl.V1Beta2
{
    ...
    /// </summary>
    [KubernetesResourceType("kubernetes:flowcontrol.apiserver.k8s.io/v1beta2:FlowSchemaPatch")]
    public partial class FlowSchemaPatch : KubernetesResource
    {
        ...
        public FlowSchemaPatch(string name, Pulumi.Kubernetes.Types.Inputs.FlowControl.V1Beta2.FlowSchemaPatchArgs? args = null, CustomResourceOptions? options = null)
            : base("kubernetes:flowcontrol.apiserver.k8s.io/v1beta2:FlowSchemaPatch", name, MakeArgs(args), MakeResourceOptions(options, ""))
        {
        }
        internal FlowSchemaPatch(string name, ImmutableDictionary<string, object?> dictionary, CustomResourceOptions? options = null)
            : base("kubernetes:flowcontrol.apiserver.k8s.io/v1beta2:FlowSchemaPatch", name, new DictionaryResourceArgs(dictionary), MakeResourceOptions(options, ""))
        {
        }

        private FlowSchemaPatch(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("kubernetes:flowcontrol.apiserver.k8s.io/v1beta2:FlowSchemaPatch", name, null, MakeResourceOptions(options, id))
        {
        }

        private static Pulumi.Kubernetes.Types.Inputs.FlowControl.V1Beta2.FlowSchemaPatchArgs? MakeArgs(Pulumi.Kubernetes.Types.Inputs.FlowControl.V1Beta2.FlowSchemaPatchArgs? args)
        {
            args ??= new Pulumi.Kubernetes.Types.Inputs.FlowControl.V1Beta2.FlowSchemaPatchArgs();
