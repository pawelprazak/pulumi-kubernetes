...
// Standard object's metadata. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#metadata
func (o NamespacePatchOutput) Metadata() metav1.ObjectMetaPtrOutput {
	return o.ApplyT(func(v *NamespacePatch) metav1.ObjectMetaPtrOutput { return v.Metadata }).(metav1.ObjectMetaPtrOutput)
}

// Spec defines the behavior of the Namespace. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#spec-and-status
func (o NamespacePatchOutput) Spec() NamespaceSpecPtrOutput {
	return o.ApplyT(func(v *NamespacePatch) NamespaceSpecPtrOutput { return v.Spec }).(NamespaceSpecPtrOutput)
}

// Status describes the current status of a Namespace. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#spec-and-status
func (o NamespacePatchOutput) Status() NamespaceStatusPtrOutput {
	return o.ApplyT(func(v *NamespacePatch) NamespaceStatusPtrOutput { return v.Status }).(NamespaceStatusPtrOutput)
}
